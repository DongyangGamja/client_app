...
export default function RegisterScreen({navigation}){
    ...
    const showToast = () =>{
      Toast.show({
        type: 'success',
        text1: 'Hi',
        text2: 'You successed registeration!'
      })
    }
        ...
        <ImageBackground source={gamjaLogo} resizeMode="center" style={{flex:1, position:"relative", }}>
            <View style={{flex:1, }}>
                    ...
                    >
                        <View style={styles.centeredView}>
                            <View style={styles.modalView}>
                                <Text style={styles.modalText}>Check the blank exists or pw&pwConfirm are same</Text>
                                <Pressable
                ...
                <View style={{flex:2.5, padding: 25}}>
                    <TextInput 
                        style={{height: 48, backgroundColor: "white", opacity:0.9,}} placeholder="Email" onChangeText={setCreateUserId} />
                    <TextInput 
                        style={{height: 48, backgroundColor: "white", opacity:0.9, marginTop: 5,}} placeholder="Password" secureTextEntry= {true} onChangeText={setCreateUserPw} />
                    <TextInput 
                        style={{height: 48, backgroundColor: "white", opacity:0.9, marginTop: 5,}} placeholder="Password Confirm" secureTextEntry= {true} onChangeText={setConfirmUserPw}/>
                    <TextInput 
                        style={{height: 48, backgroundColor: "white", opacity:0.9, marginTop: 5,}} placeholder="Username" onChangeText={setCreateUsername}/>
                    <TouchableOpacity 
                        style={{alignItems: "center", backgroundColor: "orange", marginTop: 20, paddingVertical: 10, borderRadius: 12,}}
                        onPress= {()=> {
                            if(createUserId === "" || createUserPw === "" || confirmUserPw === "" || createUsername === ""){
